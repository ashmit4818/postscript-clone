...
export default function Example() {
  ...
  return (
    <header className={`fixed w-full z-10 transition-all ${scroll ? 'backdrop-blur' : 'bg-transparent'}`}>
      <nav style={{margin: '0 3%'}} aria-label="Global" className="mx-auto flex max-w-8xl items-center justify-between p-5 lg:px-12">
        ...
        <PopoverGroup className="hidden lg:flex lg:gap-x-8">
          <Popover className="relative">
            <PopoverButton style={{ color: 'white' }} className="flex items-center gap-x-1 text-lg font-semibold">
              Solutions
            </PopoverButton>
            <PopoverPanel
          ...
          <a href="#" style={{ color: 'white' }} className="text-lg font-semibold">
            Platform
          </a>
          <a href="#" style={{ color: 'white' }} className="text-lg font-semibold">
            Proof
        ...
        <div className="hidden lg:flex lg:flex-1 lg:justify-end">
          <a href="#" style={{ color: 'white' }} className="text-md my-auto font-semibold">
            Login
          </a>
          <a
